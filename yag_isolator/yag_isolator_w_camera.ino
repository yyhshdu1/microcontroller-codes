...
const int enable_C = 4;     // camera enable pin
const int out_C = 5;        // camera output
const int enable_D = 6;     // qswitch pulse enable pin
const int out_D = 7;        // qswitch pulse output
